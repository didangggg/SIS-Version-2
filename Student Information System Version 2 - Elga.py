...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        leftcolor = tk.Label(self, height = 1260, width =550, bg = "turquoise")
        leftcolor.place(x=0, y=0)
        label = tk.Label(self, text="STUDENT INFORMATION SYSTEM", bg= "deep sky blue4", fg= "white", relief=RIDGE,font=("Arial bold", 45))
        label.place(x=130,y=20)

        home = tk.Button(self, text="HOME",font=("Arial",18,"bold"), height = 1, width = 12,relief=RIDGE, bg="deep sky blue4", fg="white", command=lambda: controller.show(Home))
        home.place(x=210,y=465)
        home.config(cursor= "hand2")
        
        course = tk.Button(self, text="COURSES",font=("Arial",18,"bold"),height = 1, width = 12,relief=RIDGE, bg="deep sky blue4", fg="white", command=lambda: controller.show(Courses))
        course.place(x=880,y=465)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="STUDENTS",font=("Arial",18, "bold"), height = 1, width = 12,relief=RIDGE, bg="deep sky blue4", fg="white", command=lambda: controller.show(Students))
        students.place(x=540,y=465)
        students.config(cursor= "hand2")

        self.students=Button(self, font=("Cooper Black",20), padx=5, width=25,height=8, bd=0, text="     ""STUDENT INFORMATION",anchor=W, bg="deep sky blue4",fg="white", command=lambda: controller.show(Students))
        self.students.config(cursor= "hand2")
        self.students.place(x=120,y=140)
        
        
        self.course=Button(self, font=("Cooper Black",20), padx =5, width=25, height=8, bd=0,  text="         ""LISTS OF COURSES",anchor=W, bg="deep sky blue4",fg="white", command=lambda: controller.show(Courses))
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="COURSE/S",bg= "deep sky blue4", fg= "white", relief=RIDGE, font=("Arial", 40, "bold"))
        ...
        student = tk.Button(self, text="STUDENTS",font=("Arial",18,"bold"), height = 1, width = 12,relief=RIDGE, bg="deep sky blue4", fg="white", command=lambda: controller.show(Students))
        student.place(x=540,y=465)
        student.config(cursor= "hand2")
        
        self.lblccode = Label(self, font=("Arial", 17, "bold"), text="Course Code:", bg= "deep sky blue4", fg= "white", relief=RIDGE, padx=5, pady=5)
        ...
        self.lblcname = Label(self, font=("Arial", 17,"bold"), text="Course Name:",bg= "deep sky blue4", fg= "white", relief=RIDGE, padx=5, pady=5)
        ...
        self.lblccode = Label(self,height = 8, width = 65,relief=RIDGE, bg="deep sky blue2", fg="white", padx=5, pady=5)
        ...
        self.adds = Button(self, text="ADD", font=("Arial",17,"bold"),bd=0,  width = 10, bg="deep sky blue4", fg="white",command=add_course)
        self.adds.place(x=100,y=320)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=("Arial",17,"bold"),bd=0,  width = 10, bg="deep sky blue4", fg="white", command=update_course) 
        self.update.place(x=100,y=380)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=("Arial",17,"bold"),bd=0,  width = 10, bg="deep sky blue4", fg="white", command=clear)
        self.clear.place(x=394,y=320)
        self.clear.config(cursor= "hand2")


        self.delete = Button(self, text="DELETE", font=("Arial",17,"bold"),bd=0,  width = 10, bg="deep sky blue4", fg="white", command=delete_course)
        self.delete.place(x=394,y=380)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=("Arial",14,"bold"),bd=0,  width = 10, bg="deep sky blue4", fg="white", command=search_course)
        self.search.place(x=1080,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=("Arial",14,"bold"),bd=0,  width = 10, bg="deep sky blue4", fg="white", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="STUDENT INFORMATION",bg= "deep sky blue4", fg= "white", relief=RIDGE, font=("Arial", 40, "bold"))
        ...
        self.lblccode = Label(self,height = 3, width =78,relief=RIDGE, bg="deep sky blue2", fg="white", padx=5, pady=5)
        self.lblccode.place(x=22,y=400)

        self.lblid = Label(self, font=("Arial", 14, "bold"), text="ID Number:", bg= "deep sky blue4", fg= "white", padx=20, pady=5)
        ...
        self.lblname = Label(self, font=("Arial", 14, "bold"), text="Name:", bg= "deep sky blue4", fg= "white", padx=38, pady=5)
        ...
        self.lblc = Label(self, font=("Arial", 14, "bold"), text="Course:", bg= "deep sky blue4", fg= "white", padx=35, pady=5)
        ...
        self.lblyear = Label(self,font=("Arial", 14, "bold"), text="Year Level:", bg= "deep sky blue4", fg= "white", padx=19, pady=5)
        ...
        self.lblgender = Label(self, font=("Arial", 14, "bold"), text="Gender:", bg= "deep sky blue4", fg= "white", padx=32, pady=5)
        ...
        self.add = Button(self, text="ADD", font=("Arial", 16, "bold"), bg= "deep sky blue4", fg= "white", padx= 20, command=add_stud)
        self.add.place(x=35,y=408)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=("Arial", 16, "bold"), bg= "deep sky blue4", fg= "white",padx= 10, command=update_stud)
        self.update.place(x=175,y=408)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=("Arial", 16, "bold"), bg= "deep sky blue4", fg= "white", padx= 10,command=clear)
        self.clear.place(x=330,y=408)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=("Arial",16, "bold"), bg= "deep sky blue4", fg= "white",padx= 6, command=delete_stud)
        self.delete.place(x=460,y=408)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=("Arial", 14, "bold"),bd=0, bg= "deep sky blue4", fg="white", command=search_stud)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=("Arial", 14, "bold"),  bd=0, bg= "deep sky blue4", fg="white",command = display_stud)
